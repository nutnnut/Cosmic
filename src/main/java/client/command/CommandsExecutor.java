...
import client.command.commands.gm0.BotSlotsCommand;
import client.command.commands.gm0.LeafCommand;
...
import client.command.commands.gm0.RingCommand;
...
import client.command.commands.gm0.JobCommand;
...
import client.command.commands.gm2.JobsCommand;
import client.command.commands.gm2.ShopCommand;
...
public class CommandsExecutor {
    ...
    private void registerLv0Commands() {
        ...
        addCommand("ring", RingCommand.class);
        addCommand("botslots", BotSlotsCommand.class);
        addCommand("leaf", LeafCommand.class);
    ...
    private void registerLv2Commands() {
        ...
        addCommand("jobs", 2, JobsCommand.class);
